...
st.markdown(
    ...
    <style>
    .stApp {
        background: linear-gradient(to right, #7fcfbf, #99d6f0); /* Slightly darker Light Green to Light Blue Gradient */
    }
...
# -----------------------------
# Title & Welcome Message (Single Line)
# -----------------------------
st.markdown(
    """
...
if st.button("Diagnose"):
    if not selected_symptoms:
        ...
        # Use .any(axis=1) for faster matching
        ...
        if not matched_diseases_counts.empty:
            ...
            # Colors: Highest -> Green, Middle -> Blue, Lowest -> Yellow
